      ...
      <div class="prop-card__body">
        ...
        <div class="prop-card__footer">
          ...
          <div class="prop-card__btns">
            <a href="https://wa.me/5491162784642?text=${encodeURIComponent('Hola! Me interesa la siguiente propiedad: ' + titulo + (p.link ? ' — ' + p.link : ''))}" target="_blank" rel="noopener" class="btn btn--sm btn--wapp" aria-label="Consultar por WhatsApp">
...
function abrirModal(p) {
  ...
  const link = p.link || '#contacto';
  document.getElementById('propModalLink').href = link;
  document.getElementById('propModalLink').target = p.link ? '_blank' : '_self';
  document.getElementById('propModalWA').href =
    `https://wa.me/5491162784642?text=${encodeURIComponent('Hola! Me interesa: ' + titulo + (p.link ? ' — ' + p.link : ''))}`;
